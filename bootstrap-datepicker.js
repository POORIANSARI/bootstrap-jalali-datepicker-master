	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-o-right"></i>' : '<i class="fa fa-arrow-circle-o-left"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<i class="fa fa-arrow-circle-o-right"></i>' : '<i class="fa fa-arrow-circle-o-left"></i>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-o-left"></i>' : '<i class="fa fa-arrow-circle-o-right"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-o-left"></i>' : '<i class="fa fa-arrow-circle-o-right"></i>') + '</a>'));
